...
const InstructorCourseUpdate = () => {
        ...
        try {
            ...
            if (token) {
                ...
                await axios.put(`http://localhost:3000/api/viewscourses/${coursesId}`, data, {
                 ...
                 window.location.href = `/createcourse/${coursesId}`
                alert('Courses Successfully Update');
    ...
    const handleUpdateTopic = async (e,topicId) => {
        ...
        try {
            ...
            if (token) {
                await axios.put(`http://localhost:3000/api/topic/${topicId}`, formDataTopic, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
                window.location.href = `/createcourse/${topicId}`
                alert('Topic Successfully Update');
    ...
    const handleUpdateLession = async (e) => {
        ...
        try {
            ...
            if (token) {
               ...
               await axios.post(`http://localhost:3000/api/lession/${lessionId}`, data, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        Authorization: `Bearer ${token}`
                    }
                });
                  window.location.href = `/createcourse/${lessionId}`
    ...
    const handleUpdateVideo = async (e) => {
        ...
        try {
            ...
            if (token) {
                ...
                window.location.href = `/createcourse/${videoId}`
                                            ...
                                            <div className="accordion-body">
                                                <div className="accordion-body">
                                                    <div className="course-information-area">
                                                        <form className="top-form-create-course" onSubmit={handleUpdateCourse}>
                                    ...
                                    <div className="accordion" id="accordionExampls3">
                                        ...
                                        <div className="accordion-item">
                                            ...
                                            {isExpanded === 'collapseTwo' && (<div id="collapseTwo" className={`accordion-collapse collapse ${isExpanded ? 'show' : ''}`} aria-labelledby="headingTwo" data-bs-parent="#accordionExampls3">
                                                <div className="accordion-body">
                                                    <div className="course-information-area">
                                                        <form action="#" className="top-form-create-course" onSubmit={handleUpdateTopic} >
                                                            <div className="single-input">
                                    ...
                                    <div className="accordion" id="accordionExampls2">
                                        ...
                                        <div className="accordion-item">
                                            ...
                                            {isExpanded === 'collapseThree' && (<div id="collapseThree" className={`accordion-collapse collapse ${isExpanded ? 'show' : ''}`} aria-labelledby="headingThree" data-bs-parent="#accordionExampls2">
                                                <div className="accordion-body">
                                                    <div className="course-information-area">
                                                        <form className="top-form-create-course" onSubmit={handleUpdateLession}>
                                                            <div className="single-input">
                                    ...
                                    <div className="accordion" id="accordionExampls2">
                                        ...
                                        <div className="accordion-item">
                                            ...
                                            {isExpanded === 'collapseFour' && (<div id="collapseFour" className={`accordion-collapse collapse ${isExpanded ? 'show' : ''}`} aria-labelledby="headingFour" data-bs-parent="#accordionExampls2">
                                                <div className="accordion-body">
                                                    <div className="course-information-area">
                                                        <form action="#" className="top-form-create-course" onSubmit={handleUpdateVideo}>
