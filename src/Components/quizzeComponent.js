    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (token) {
                ...
                response = await axios.post('http://localhost:3000/api/quizze', formData, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
                                        ...
                                        <div class="modal-content p-3 p-md-5">
                                            <div class="modal-body">
                                                ...
                                                <form id="editUserForm" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" onSubmit={handleUpdate} novalidate="novalidate">
                                                    ...
                                                    <div class="col-12 col-md-6 fv-plugins-icon-container">
                                                        <label class="form-label" for="add-user-contact">Quizze Start Time</label>
                                                        <input type="time" id="add-user-contact" class="form-control phone-mask" placeholder="Quizz Start Time" name="QuizzStartTime"
                                                            onChange={(e) => setQuizzStartTime(e.target.value)}
                                                            value={QuizzStartTime} />
                                                    </div>
                                                    <div class="col-12 col-md-6 fv-plugins-icon-container">
                                                        <label class="form-label" for="add-user">Quizze End Time</label>
                                                        <input type="time" id="add-user" class="form-control" placeholder="Quizz End Time" name="QuizzEndTime"
                                                            onChange={(e) => setQuizzEndTime(e.target.value)}
                                                            value={QuizzEndTime} />
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-md-6 fv-plugins-icon-container">
                                                        ...
                                                        <input type="date" id="add-user" class="form-control" placeholder="Quizze Test Duration" name="QuizzTestDuration"
                                                            onChange={(e) => setQuizzTestDuration(e.target.value)}
                                                            value={QuizzTestDuration} />
                                                    </div>
                                                    <div class="col-12 col-md-6 fv-plugins-icon-container">
                                                    ...
                                                    <div class="col-12 col-md-6 fv-plugins-icon-container">
                                                        <label for="exampleFormControlSelect2" class="form-label">Batch</label>
                                                        <select id="exampleFormControlSelect2" class="select2 form-select" name="BatchId" defaultValue={BatchId} onChange={(e) => setBatchId(e.target.value)}>
                                                            <option value="">Select</option>
                                                            {batch.map((option) => (
                                                                <option key={option.id} value={option.id}>{option.Title}</option>
                                                            ))}
