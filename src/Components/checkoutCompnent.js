  ...
  return (
    <div>
     ...
     <DashboardCard/>
      ...
      <div class="dashboard--area-main pt--30 pt_sm--50">
      <main class="ms-main" >
        <div class="ms-page-content" >

            <article id="post-284" class="page checkout-area type-page status-publish hentry container py-5" style={{backgroundColor:'#fff'}}>
                ...
                <div class="ms-default-page container entry-content">
                    <div class="woocommerce">
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingOne">
                                        <div class="card-title">
                                            ...
                                            <button class="accordion-toggle collapsed" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" onClick={handleClose}>Click here to enter your code</button>
                                        </div>
                                    </div>
                                    {isClose &&
                        ...
                        <form name="checkout" method="post" class="checkout woocommerce-checkout ms-woocommerce-checkout" action="#" enctype="multipart/form-data" novalidate="novalidate" style={{backgroundColor:'#fff',padding:'20px'}}>
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="full-grid">
                                        ...
                                        <div class="payment-method mt-40 md-mt-20">
                                            <div class="top-area">
                                                <div class="payment-co"><span>PayPal</span> <img src="assets/fontend/images/paypal.png" alt="PayPal Logo"/></div>
                                            ...
                                            <tbody>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="ms-checkout-product">
                                                            <div class="ms-checkout-product__thumbnail">
                                                                <img src="assets/fontend/images/shop/01.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Shop Image"/>
                                                            </div>
                                                ...
                                                <tr class="cart_item">
                                                    <td colspan="2">
                                                        <div class="ms-checkout-product">
                                                            <div class="ms-checkout-product__thumbnail">
                                                                <img src="assets/fontend/images/shop/04.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Shop Image"/>
                                                            </div>
                                                            <div class="ms-checkout-product__content">
