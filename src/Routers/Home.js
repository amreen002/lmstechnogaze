            ...
            <div className="banner-area-one shape-move">
                            ...
                            <div className="banner-content-one">
                                <div className="inner">
                                    <div className="pre-title-banner">
                                        ...
                                        <span>Hey there, Middle Schoolers!</span>
                                    </div>
                                    ...
                                    <div className="banner-btn-author-wrapper">
                                        ...
                                        <div className="sm-image-wrapper">
                                            ...
                                            <div className="info">
                                                ...
                                                <span>Joint our online className</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="review-thumb">
                    ...
                    <div className="review-single">
                        <img src="assets/fontend/images/banner/03.png" alt="banner" />
                    ...
                    <div className="review-single two">
                        <img src="assets/fontend/images/banner/04.png" alt="banner" />
                        <div className="info-right">
                            ...
                            <div className="about-one-left-image">
                                <div className="first-order">
                                    <div className="thumb-one">
                                        <img src="assets/fontend/images/about/03.jpg" alt="about" />
                                        <div className="information">
                                            <div className="left">
                                                <h3 className="title"><span class="counter animated fadeInDownBig">2.4</span>k</h3>
                                    ...
                                    <div className="thumb-bottom">
                                        <img src="assets/fontend/images/about/6.png" alt="about" />
                                    </div>
                                </div>
                            ...
                            <div className="about-inner-right-one">
                                ...
                                <div className="author-area">
                                    <div className="single-author-and-info">
                                        <img src="assets/fontend/images/about/01.png" alt="about" />
                                        <div className="information">
                                            <a href="#">
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 pl--90 pl_md--15 mt_md--50 pl_sm--15 pt_sm--50">
                            ...
                            <div className="why-choose-main-wrapper-1">
                                ...
                                <div className="single-choose-reason-1">
                                    <div className="icon">
                                        <img src="assets/fontend/images/why-choose/icon/06.png" alt="icon" />
                                    </div>
                                            ...
                                            <ul>
                                                ...
                                                <li><i className="fa-sharp fa-regular fa-star"></i></li>
                                                        ...
                                                        <div className="price-area">
                                                            ...
                                                            <div className="price pl-5px" >{item.CoursePrice}
